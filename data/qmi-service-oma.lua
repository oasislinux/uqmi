  ...
  {  name      = "Event Report",
     ...
     output    = { { name        = "Network Initiated Alert",
                     ...
                     contents    = { { name            = "Session Type",
                                       format          = "guint8",
                                       public_format   = "QmiOmaSessionType" },
                                     { name     = "Session ID",
                                       format   = "guint16" } } },
                    { name            = "Session State",
                      id              = "0x11",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiOmaSessionState" },
                    { name            = "Session Fail Reason",
                      id              = "0x12",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiOmaSessionFailedReason" } } },
  ...
  {  name      = "Get Feature Setting",
     ...
     output    = { { name            = "Device Provisioning Service Update Config",
                   ...
                   { name            = "HFA Feature Done State",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiOmaHfaFeatureDoneState",
                     prerequisites   = { { common_ref   = "Success" } } },
                   { common_ref   = "Operation Result" } } },
