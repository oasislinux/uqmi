  ...
  {  name      = "Event Report",
     ...
     output    = { { name        = "MT Message",
                     ...
                     contents    = { { name            = "Storage Type",
                                       format          = "guint8",
                                       public_format   = "QmiWmsStorageType" },
                                     { name     = "Memory Index",
                                       format   = "guint32" } } },
                   { name        = "Transfer Route MT Message",
                     ...
                     contents    = { { name            = "Ack Indicator",
                                       format          = "guint8",
                                       public_format   = "QmiWmsAckIndicator" },
                                     { name     = "Transaction ID",
                                       format   = "guint32" },
                                     { name            = "Format",
                                       format          = "guint8",
                                       public_format   = "QmiWmsMessageFormat" },
                                     { name                 = "Raw Data",
                                       format               = "array",
                   ...
                   { name            = "Message Mode",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiWmsMessageMode" },
                   { name        = "ETWS Message",
                     id          = "0x13",
                     mandatory   = "no",
                     type        = "TLV",
                     ...
                     contents    = { { name            = "Notification Type",
                                       format          = "guint8",
                                       public_format   = "QmiWmsNotificationType" },
                                     { name                 = "Raw Data",
                                       format               = "array",
                                       size_prefix_format   = "guint16",
                                       array_element        = { format   = "guint8" } } } },
  ...
  {  name      = "Raw Send",
     ...
     input     = { { name        = "Raw Message Data",
                   ...
                   { name        = "CDMA Force On DC",
                     ...
                     contents    = { { name            = "Force",
                                     ...
                                     { name            = "Service Option",
                                       format          = "guint8",
                                       public_format   = "QmiWmsCdmaServiceOption" } } },
     ...
     output    = { { common_ref   = "Operation Result" },
                   ...
                   { name            = "CDMA Cause Code",
                     ...
                     type            = "TLV",
                     format          = "guint16",
                     public_format   = "QmiWmsCdmaCauseCode",
                   ...
                   { name            = "CDMA Error Class",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiWmsCdmaErrorClass",
                     prerequisites   = { { field       = "Result.Error Status",
                                           operation   = "!=",
                                           value       = "QMI_STATUS_SUCCESS" },
                                         { field       = "Result.Error Code",
                   ...
                   { name            = "GSM WCDMA Cause Info",
                     ...
                     contents        = { { name            = "RP Cause",
                                           format          = "guint16",
                                           public_format   = "QmiWmsGsmUmtsRpCause" },
                                         { name            = "TP Cause",
                                           format          = "guint8",
                                           public_format   = "QmiWmsGsmUmtsTpCause" } },
                     prerequisites   = { { field       = "Result.Error Status",
                                           operation   = "!=",
                                           value       = "QMI_STATUS_SUCCESS" },
                                         { field       = "Result.Error Code",
                   ...
                   { name            = "Message Delivery Failure Type",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiWmsMessageDeliveryFailureType",
                     prerequisites   = { { field       = "Result.Error Status",
                                           operation   = "!=",
                                           value       = "QMI_STATUS_SUCCESS" },
                                         { field       = "Result.Error Code",
     ...
     output     = { { common_ref   = "Operation Result" },
                    { name        = "Raw Message Data",
                      ...
                      contents    = { { name            = "Message Tag",
                                        format          = "guint8",
                                        public_format   = "QmiWmsMessageTagType" },
                                      { name            = "Format",
                                        format          = "guint8",
                                        public_format   = "QmiWmsMessageFormat" },
                                      { name                 = "Raw Data",
  ...
  {  name      = "Get Message Protocol",
     ...
     output     = { { common_ref   = "Operation Result" },
                    { name            = "Message Protocol",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiWmsMessageProtocol",
                      prerequisites   = { { common_ref   = "Success" } } } } },
     ...
     input     = { { name                 = "Route List",
                     ...
                     array_element        = { name       = "Element",
                                              ...
                                              contents   = { { name            = "Message Type",
                                                               format          = "guint8",
                                                               public_format   = "QmiWmsMessageType" },
                                                             { name            = "Message Class",
                                                               format          = "guint8",
                                                               public_format   = "QmiWmsMessageClass" },
                                                             { name            = "Storage",
                                                               format          = "guint8",
                                                               public_format   = "QmiWmsStorageType" },
                                                             { name            = "Receipt Action",
                                                               format          = "guint8",
                                                               public_format   = "QmiWmsReceiptAction" } } } },
                   { name            = "Transfer Status Report",
                     id              = "0x10",
                     mandatory       = "no",
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiWmsTransferIndication" } },
     output     = { { common_ref   = "Operation Result" } } },
