return {
     ...
     output    = { { name        = "NMEA Position",
                   ...
                   { name        = "Extended NMEA Position",
                     ...
                     contents    = { { name            = "Operation Mode",
                                       format          = "gint8",
                                       public_format   = "QmiPdsOperationMode" },
                                     { name       = "NMEA",
                                       format     = "string",
                   ...
                   { name            = "Position Session Status",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiPdsPositionSessionStatus" } } },
                   ...
                   { name        = "State",
                     ...
                     contents    = { { name            = "GPS Service State",
                                     ...
                                     { name            = "Tracking Session State",
                                       format          = "guint8",
                                       public_format   = "QmiPdsTrackingSessionState" } },
     ...
     output    = { { common_ref   = "Operation Result" },
                   { name        = "Info",
                     ...
                     contents    = { { name            = "Session Operation",
                                       format          = "guint8",
                                       public_format   = "QmiPdsOperatingMode" },
  ...
  {  name      = "Get AGPS Config",
     ...
     input     = { { name            = "Network Mode",
                     ...
                     type            = "TLV",
                     format          = "guint8",
                     public_format   = "QmiPdsNetworkMode" } },
     output    = { { common_ref   = "Operation Result" },
