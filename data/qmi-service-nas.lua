return {
     ...
     output    = {  { name        = "Signal Strength",
                      ...
                      contents    = { { name     = "Strength",
                                      ...
                                      { name            = "Radio Interface",
                                        format          = "gint8",
                                        public_format   = "QmiNasRadioInterface" } } },
                    { name                 = "RF Band Information",
                      id                   = "0x11",
                      mandatory            = "no",
                      type                 = "TLV",
                      format               = "array",
                      array_element        = { name       = "Element",
                                               format     = "struct",
                                               contents   = { { name            = "Radio Interface",
                                                              ...
                                                              { name            = "Active Band Class",
                                                                format          = "guint16",
                                                                public_format   = "QmiNasActiveBand" },
                                                              { name            = "Active Channel",
                                                                format          = "guint16" } } } },
                    { name        = "Registration Reject Reason",
                      id          = "0x12",
                      ...
                      contents    = { { name            = "Service Domain",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkServiceDomain" },
                                      { name     = "Reject Cause",
                                        format   = "guint16" } } },
                    { name        = "RSSI",
                      id          = "0x13",
                    ...
                    { name            = "SINR",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasEvdoSinrLevel" },
                    { name        = "Error Rate",
                      id          = "0x17",
                      mandatory   = "no",
                      type        = "TLV",
  ...
  {  name      = "Get Signal Strength",
     ...
     input     = {  { name            = "Request Mask",
                      ...
                      type            = "TLV",
                      format          = "guint16",
                      public_format   = "QmiNasSignalStrengthRequest" } },
     output    = {  { common_ref   = "Operation Result" },
  ...
  {  name      = "Network Scan",
     ...
     input     = {  { name            = "Network Type",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasNetworkScanType" } },
     output    = {  { common_ref   = "Operation Result" },
                    { name                 = "Network Information",
                      ...
                      array_element        = { name       = "Element",
                                               ...
                                               contents   = { { name     = "MCC",
                                                              ...
                                                              { name            = "Network Status",
                                                                format          = "guint8",
                                                                public_format   = "QmiNasNetworkStatus" },
                                                              { name     = "Description",
                                                                format   = "string" } } } },
  ...
  {  name      = "Initiate Network Register",
     ...
     input     = {  { name            = "Action",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasNetworkRegisterType" },
                    ...
                    { name            = "Change Duration",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasChangeDuration" },
                    { name            = "MNC PCS Digit Include Status",
                      id              = "0x12",
                      mandatory       = "no",
                      type            = "TLV",
     ...
     output    = {  { common_ref   = "Operation Result" },
                    { name        = "Serving System",
                      ...
                      contents    = { { name            = "Registration State",
                                        format          = "guint8",
                                        public_format   = "QmiNasRegistrationState" },
                                      { name            = "CS Attach State",
                                        format          = "guint8",
                                        public_format   = "QmiNasAttachState" },
                                      { name            = "PS Attach State",
                                        format          = "guint8",
                                        public_format   = "QmiNasAttachState" },
                                      { name            = "Selected Network",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkType" },
                    ...
                    { name            = "Roaming Indicator",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasRoamingIndicatorStatus" },
                    { name            = "Data Service Capability",
                      ...
                      format          = "array",
                      array_element   = { format          = "guint8",
                                          public_format   = "QmiNasDataCapability" } },
                    { name        = "Current PLMN",
                      id          = "0x12",
                      mandatory   = "no",
                      type        = "TLV",
                    ...
                    { name        = "Detailed Service Status",
                      ...
                      contents    = { { name            = "Status",
                                        format          = "guint8",
                                        public_format   = "QmiNasServiceStatus" },
                                      { name            = "Capability",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkServiceDomain" },
                                      { name            = "HDR Status",
                    ...
                    { name            = "HDR Personality",
                      ...
                      type            = "TLV",
                      format          = "guint8",
                      public_format   = "QmiNasHdrPersonality"},
                    { name        = "LTE TAC",
                      id          = "0x24",
                      mandatory   = "no",
                      type        = "TLV",
                    ...
                    { name        = "Call Barring Status",
                      ...
                      contents    = { { name            = "CS Status",
                                        format          = "gint32",
                                        public_format   = "QmiNasCallBarringStatus" },
                                      { name            = "PS Status",
                                        format          = "gint32",
                                        public_format   = "QmiNasCallBarringStatus" } } },
                    ...
                    { name        = "Home Network 3GPP2",
                      ...
                      contents    = { { name     = "MCC",
                                      ...
                                      { name            = "Display Description",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkDescriptionDisplay" },
                                      { name            = "Description Encoding",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkDescriptionEncoding" },
                                      { name   = "Description",
                                        format   = "string" } } } } },
  ...
  {  name      = "Set Technology Preference",
     ...
     input     = {  { name        = "Current",
                      ...
                      contents    = { { name            = "Technology Preference",
                                        format          = "guint16",
                                        public_format   = "QmiNasRadioTechnologyPreference" },
                                      { name            = "Technology Preference Duration",
                                        format          = "guint8",
                                        public_format   = "QmiNasPreferenceDuration" } } } },
     output    = {  { common_ref   = "Operation Result" } } },
  ...
  {  name      = "Set System Selection Preference",
     ...
     input     = {  { name            = "Emergency mode",
                    ...
                    { name            = "Mode Preference",
                      ...
                      type            = "TLV",
                      format          = "guint16",
                      public_format   = "QmiNasRatModePreference" },
                    { name            = "Band Preference",
                      id              = "0x12",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint64",
                      public_format   = "QmiNasBandPreference" },
                    { name            = "CDMA PRL Preference",
                      id              = "0x13",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint16",
                      public_format   = "QmiNasCdmaPrlPreference" },
                    { name            = "Roaming Preference",
                      id              = "0x14",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint16",
                      public_format   = "QmiNasRoamingPreference" },
                    { name            = "LTE Band Preference",
                      id              = "0x15",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint64",
                      public_format   = "QmiNasLteBandPreference" },
                    { name        = "Network Selection Preference",
                      ...
                      contents    = { { name            = "Mode",
                                        format          = "guint8",
                                        public_format   = "QmiNasNetworkSelectionPreference" },
                                      { name     = "MCC",
                                        format   = "guint16" },
                                      { name     = "MNC",
                                        format   = "guint16" } } },
                    ...
                    { name            = "Service Domain Preference",
                      ...
                      type            = "TLV",
                      format          = "guint32",
                      public_format   = "QmiNasServiceDomainPreference" },
                    { name            = "GSM WCDMA Acquisition Order Preference",
                      id              = "0x19",
                      mandatory       = "no",
                      type            = "TLV",
                      format          = "guint32",
                      public_format   = "QmiNasGsmWcdmaAcquisitionOrderPreference" },
                    ...
                    { name            = "TD SCDMA Band Preference",
                      ...
                      type            = "TLV",
                      format          = "guint64",
                      public_format   = "QmiNasTdScdmaBandPreference" } },
     output    = {  { common_ref   = "Operation Result" } } },
     ...
     output    = {  { common_ref   = "Operation Result" },
                    ...
                    { name        = "UMTS Info Neighboring LTE",
                      ...
                      contents    = { { name            = "RRC state",
                                        format          = "guint32",
                                        public_format   = "QmiNasWcdmaRrcState" },
                                      { name            = "Frequency",
                                        format          = "array",
                                        array_element   = { name       = "Element",
                                                            format     = "struct",
  ...
  {  name      = "Network Time",
     ...
     output    = {  { name        = "Universal Time",
                    ...
                    { name        = "Daylight Savings Adjustment",
                      ...
                      type        = "TLV",
                      format      = "guint8",
                      public_format   = "QmiNasDaylightSavingsAdjustment" },
                    { name        = "Radio Interface",
                      id          = "0x12",
                      mandatory   = "no",
                      type        = "TLV",
     ...
     output    = {  { common_ref   = "Operation Result" },
                    ...
                    { name        = "CDMA System Info",
                      ...
                      contents    = { { name            = "Domain Valid",
                                      ...
                                      { name            = "Roaming Status",
                                        format          = "guint8",
                                        public_format   = "QmiNasRoamingStatus" },
                    ...
                    { name        = "HDR System Info",
                      ...
                      contents    = { { name            = "Domain Valid",
                                      ...
                                      { name            = "Protocol Revision",
                                        format          = "guint8",
                                        public_format   = "QmiNasHdrProtocolRevision" },
                    ...
                    { name        = "WCDMA System Info",
                      ...
                      contents    = { { name            = "Domain Valid",
                                      ...
                                      { name            = "HS Call Status",
                                        format          = "guint8",
                                        public_format   = "QmiNasWcdmaHsService" },
                    ...
                    { name        = "Additional GSM System Info",
                      ...
                      contents    = { { name     = "Geo System Index",
                                      ...
                                      { name            = "Cell Broadcast Support",
                                        format          = "guint32",
                                        public_format   = "QmiNasCellBroadcastCapability" } } },
                    ...
                    { name            = "SIM Reject Info",
                      ...
                      type            = "TLV",
                      format          = "guint32",
                      public_format   = "QmiNasSimRejectState" } } },
                   ...
                   { name         = "CDMA Position Info",
                     ...
                     contents     = { { name                 = "UI In Idle Mode",
                                      ...
                                      { name                 = "BaseStations",
                                        ...
                                        array_element        = { name       = "BaseStation",
                                                                 format     = "struct",
                                                                 contents   = { { name            = "Pilot Type",
                                                                                  format          = "guint32",
                                                                                  public_format   = "QmiNasCdmaPilotType" },
                                                                                { name            = "System ID",
                                                                                  format          = "guint16" },
                                                                                { name            = "Network ID",
                                                                                  format          = "guint16" },
