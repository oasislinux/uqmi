  ...
  {  name      = "Read Transparent",
     ...
     input     = { { name        = "Session Information",
                     ...
                     contents    = { { name            = "Session Type",
                                       format          = "guint8",
                                       public_format   = "QmiUimSessionType" },
                   ...
                   { name                 = "File Attributes",
                     ...
                     contents             = { { name     = "File Size",
                                              ...
                                              { name            = "Read Security Attributes Logic",
                                                format          = "guint8",
                                                public_format   = "QmiUimSecurityAttributeLogic" },
                                              { name            = "Read Security Attributes",
                                                format          = "guint16",
                                                public_format   = "QmiUimSecurityAttribute" },
                                         ...
                                         { name                 = "Cards",
                                           ...
                                           array_element        = { name     = "Element",
								                                    ...
								                                    contents   = { { name            = "Card State",
										                                             format          = "guint8",
                                                                                     public_format   = "QmiUimCardState" },
										                                           { name            = "UPIN State",
										                                             format          = "guint8",
                                                                                     public_format   = "QmiUimPinState" },
										                                           { name     = "UPIN Retries",
										                                             format   = "guint8" },
										                                           { name     = "UPUK Retries",
										                                             format   = "guint8" },
										                                           ...
										                                           { name                 = "Applications",
										                                             ...
										                                             array_element        = { name     = "Element",
													                                                          ...
													                                                          contents   = { { name            = "Type",
															                                                                   format          = "guint8",
                                                                                                                               public_format   = "QmiUimCardApplicationType" },
															                                                                 { name            = "State",
															                                                                   format          = "guint8",
                                                                                                                               public_format   = "QmiUimCardApplicationState" },
															                                                                 { name            = "Personalization State",
															                                                                   format          = "guint8",
                                                                                                                               public_format   = "QmiUimCardApplicationPersonalizationState" },
															                                                                 { name            = "Personalization Feature",
															                                                                   format          = "guint8",
                                                                                                                               public_format   = "QmiUimCardApplicationPersonalizationFeature" },
